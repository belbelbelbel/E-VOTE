...
export const ElectionOnHold = ({ start_time, stop_time }: iTimeProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center  justify-center bg-black  bg-opacity-70 xl:bg-opacity-50">
      <div className="bg-white p-8 rounded-lg shadow-md relative flex-col  pb-10 mx-auto justify-center items-center flex h-[40vh] w-[90%] xl:w-[60%] xl:h-[55vh] text-center">
        <div className=" flex flex-col items-center xl:gap-3  gap-[2.3vw]">
          ...
          <div className="xl:text-[21px] md:text-[2rem] text-[3.8vw] ">
        ...
        <button
          className=" text-white fonts-mid px-8 py-2 w-[70%] md:h-[7vh] xl:text-[2vw] text-[4vw] absolute xl:bottom-5 bg-red-600 uppercase   bottom-3 xl:text-[2vw] xl:w-[40%] rounded "
