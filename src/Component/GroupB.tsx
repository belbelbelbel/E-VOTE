                            ...
                            {candidates?.map((candidate: any) => (
                                ...
                                >
                                    ...
                                    <div className="flex flex-col relative items-center justify-center xl:gap-2">
                                        ...
                                        <button
                                            className={`text-white xl:w-[60%] w-[31vw] md:w-[29vw] xl:text-[1.25vw] text-[4vw] mx-auto xl:h-[3.5vw] md:h-[8vw] h-[9vw] rounded-[4px] md:rounded-[4px] xl:rounded-[4px] mt-3 ${voted === candidate._id
                                                    ? "bg-[#209254]"
                                                    : "bg-[#828282]"
                                                }`}
            ...
            <div className="w-[80%]  mx-auto xl:mt-0 mb-0 md:mb-[4vw] my-[0vw]   xl:h-0 h-full flex items-center relative xl:-top-[1vw] justify-center">
                {
                    !isloading && (
                        <button
                            className={`text-white  xl:w-[44%] w-full h-[6.5vh] md:h-[13.2vw] xl:text-[1.5vw] text-[4vw] mx-auto xl:h-[3.5vw] fonts-mid rounded-[6px] md:rounded-[10px] xl:rounded-[4px] mt-0 ${voted === null
