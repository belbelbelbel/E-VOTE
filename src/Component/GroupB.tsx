                    ...
                    {imgArray.map((img) => (
                        <div key={img.id} className='flex xl:flex-col gap-[10vw] xl:gap-2'>
                            ...
                            <div className='flex flex-col items-center justify-center xl:gap-2'>
                                ...
                                <button
                                    className={`text-white  xl:w-[60%] w-[31vw] md:w-[29vw]  xl:text-[1.25vw]  text-[4vw] mx-auto xl:h-[3vw] md:h-[8vw] h-[9vw] rounded-[4px] md:rounded-[4px] fonts-mid xl:rounded-[4px] mt-3 ${voted === img.id ? "bg-[#209254]" : "bg-[#828282]"}`}
