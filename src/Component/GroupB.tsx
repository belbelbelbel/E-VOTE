    ...
    return (
        ...
        <div className='flex xl:hidden z-50 text-white justify-between min-h-[15%] w-full items-center flex bg-[#0250FC]'>
            <div className='w-[80%]  mx-auto flex  justify-between h-[15%] items-center flex'>
                ...
                <div className='tracking-[4px] text-[4.1vw] fonts-mid'>GROUP B</div>
                <div></div>
            </div>
        </div>
        ...
        <div className='xl:hidden my-[7vw] text-[4.5vw] text-center tracking-[1px]'>Vote for the candidate of your choice</div>
            ...
            {imgArray.map((img) => (
                <div key={img.id} className='flex xl:flex-col gap-[10vw] xl:gap-2'>
                    ...
                    <div className='flex flex-col items-center justify-center xl:gap-2'>
                        <div className='text-center fonts-mid font-medium'>{img.name}</div>
                        <button
                            className={`text-white  xl:w-[60%] w-[30vw] mx-auto xl:h-[3vw] h-[10vw] fonts-mid rounded-[4px] mt-3 ${voted === img.id ? "bg-[#209254]" : "bg-[#828282]"}`}
