...
export const GroupA = () => {
  ...
  const callSaveVoteApi = async (updatedPayload) => {
    try {
  ...
  return (
    <div className="xl:h-full z-50 w-full relative flex flex-col xl:gap-[4.6rem] gap-[5vw] xl:items-center xl:justify-evenly group_cont">
              ...
              <div className="flex flex-col items-center justify-center xl:gap-2">
                ...
                <button
                  className={`text-white xl:w-[60%] w-[31vw] md:w-[29vw] xl:text-[1.25vw] text-[4vw] mx-auto xl:h-[3.5vw] md:h-[8vw] h-[9vw] rounded-[4px] md:rounded-[4px] xl:rounded-[4px] mt-3 ${
                    voted === candidate._id ? "bg-[#209254]" : "bg-[#828282]"
                  }`}
      ...
      <div className="w-[89%] mx-auto xl:mt-0 mb-0 md:mb-[4vw] my-[0vw] xl:h-0 h-full flex items-center relative xl:-top-[1vw] justify-center">
        <button
          className={`text-white xl:w-[22%] w-full h-[9vh] md:h-[13.2vw] xl:text-[1.25vw] text-[4vw] mx-auto xl:h-[3.5vw] fonts-mid rounded-[6px] md:rounded-[10px] xl:rounded-[4px] mt-0 ${
            voted === null
